...
FROM [EcoBici].[dbo].[recorridos-realizados-2018] rr
...
FROM (
	...
	FROM [EcoBici].[dbo].[recorridos-realizados-2018]
...
INNER JOIN EcoBici.dbo.[estaciones-de-bicicletas-publicas] estaciones ON estaciones.nro_est=origen.bici_estacion_origen
