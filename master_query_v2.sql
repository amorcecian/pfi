...
--INNER JOIN [pfidb].[dbo].[estaciones-de-bicicletas-publicas] origen on rr.bici_estacion_origen=origen.nro_est
...
INNER JOIN pfidb.dbo.[estaciones-de-bicicletas-publicas] estaciones ON estaciones.nro_est=origen.bici_estacion_origen
